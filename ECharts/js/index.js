 ...
 * @LastEditors: by_mori
 * @LastEditTime: 2021-09-30 15:02:25
 */
// 柱状图1模块
(function () {
  // 实例化对象
...
(function () {
  ...
  var YCData = [
    ...
    [{ name: '银川' }, { name: '成都', value: 100 }],
  ];
  var CDData = [
    [{ name: '成都' }, { name: '呼和浩特', value: 100 }],
    [{ name: '成都' }, { name: '拉萨', value: 100 }],
    [{ name: '成都' }, { name: '连云港', value: 100 }],
    [{ name: '成都' }, { name: '金华', value: 100 }],
    [{ name: '成都' }, { name: '长沙', value: 100 }],
  ...
  var color = ['#a6c84c', '#ffa022', '#46bee9', '#006cff']; //航线的颜色
  var series = [];
  [
    ['西安', XAData],
    ['西宁', XNData],
  ...
  var option = {
    ...
    legend: {
      ...
      top: 'bottom',
      left: 'left',
      data: ['西安 Top3', '西宁 Top3', '银川 Top3', '成都 Top3'],
      textStyle: {
        color: '#fff',
      },
